...
const EMAIL_TEMPLATE = {
    ...
    SUBSCRIPTION_UPDATE_ADMIN: 'SUBSCRIPTION_UPDATE_ADMIN',
    SUBSCRIPTION_CANCEL_ADMIN: 'SUBSCRIPTION_CANCEL_ADMIN'
}
...
const RAZORPAY_SUBSCRIPTION_TYPE ={
    ACTIVE: 'ACTIVE',
    PENDING_CANCELLATION: 'PENDING_CANCELLATION',
    CANCEL : 'CANCELLED',
    EXPIRED: 'EXPIRED',
