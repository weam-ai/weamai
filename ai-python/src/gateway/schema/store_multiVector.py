...
from src.gateway.schema.utils import validate_id_field, FILE_SOURCE_BUCKET
...
class ProcessTextRequest(BaseModel):
    ...
    source: str = Field(FILE_SOURCE_BUCKET, description="Source of the file (e.g., S3 bucket URL).")
...
class OpenAIMultiVectorStore(BaseModel):
    payload_list:List[OpenAIProcessTextRequest]=Field(...,description="List of OpenAI text Request")
