...
class SalesTranscriptService:
    ...
    async def initilize_chat_input(self,chat_input=None):
        ...
        self.transcript=self.chat_input.query
    ...
    async def initialize_llm(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "SalesTranscriptService.initialize_llm"}}
            )
    ...
    async def initialize_repository(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "SalesTranscriptService.initialize_repository"}}
            )
    ...
    def initialize_memory(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "SalesTranscriptService.initialize_memory"}}
            )
    ...
    async def create_chain(self):
        ...
        try:
            ...
            logger.error(f"Failed to create chain: {e}",
                         extra={"tags": {"method": "SalesTranscriptService.create_chain"}})
    ...
    async def run_chain(self,kwargs={}):
            try:
                ...
                logger.error(
                    ...
                    extra={"tags": {"method": "SalesTranscriptService.run_chain.ResourceExhausted"}})
                self.thread_repo.initialization(self.thread_id, self.thread_model)
                ...
                logger.error(
                    f"🚨 Google API Error: {error_content}",
                    extra={"tags": {"method": "SalesTranscriptService.run_chain.GoogleAPICallError"}})
                self.thread_repo.initialization(self.thread_id, self.thread_model)
            ...
            # Handle GoogleAPIError
                ...
                logger.error(
                    f"🚨 Google API Error: {error_content}",
                    extra={"tags": {"method": "SalesTranscriptService.run_chain.GoogleAPIError"}})
                self.thread_repo.initialization(self.thread_id, self.thread_model)
                ...
                logger.error(
                    f"🚨 Google API Error: {error_content}",
                    extra={"tags": {"method": "SalesTranscriptService.run_chain.GoogleGenerativeAIError"}})
                self.thread_repo.initialization(self.thread_id, self.thread_model)
                ...
                try:
                    ...
                    try:
                        ...
                        logger.warning(
                            ...
                            extra={"tags": {"method": "SalesTranscriptService.Exception.extract_google_error_message"}})
                    ...
                    if not error_content:
                        try:
                            ...
                            logger.warning(
                                ...
                                extra={"tags": {"method": "SalesTranscriptService.Exception.extract_google_genai_error_message"}})
                    ...
                    logger.error(
                        ...
                        extra={"tags": {"method": "SalesTranscriptService.run_chain.Exception_Try"}})
                    self.thread_repo.initialization(self.thread_id, self.thread_model)
                    ...
                    logger.error(
                        ...
                        extra={"tags": {"method": "SalesTranscriptService.run_chain.Exception_Except"}})
                    self.thread_repo.initialization(self.thread_id, self.thread_model)
                    self.thread_repo.add_message_gemini("common_response")
