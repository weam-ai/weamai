...
from src.prompts.langchain.openai.simple_system_prompt import general_system_template,general_user_template,general_ai_template,user_additional_prompt,general_image_template
