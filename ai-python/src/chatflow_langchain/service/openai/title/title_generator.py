    ...
    def run_chain(self, chat_session_id: str = None, collection_name: str = None, collection_chatmember: str = None):
        ...
        try:
            with get_openai_callback() as cb :
                ...
                # self.api_usage_service.update_usage_sync(provider=llm_apikey_decrypt_service.bot_data.get('code', 'OPEN_AI'), tokens_used=cb.total_tokens, model=OPENAIMODEL.GPT_4_1_MINI, api_key=llm_apikey_decrypt_service.apikey, functionality=Functionality.CHAT,company_id=llm_apikey_decrypt_service.companyRedis_id)
