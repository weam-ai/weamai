...
from src.chatflow_langchain.service.openai.custom_gpt.doc.rag_conversation import OpenAICustomGPTStreamingDocChatService
from src.chatflow_langchain.service.openai.custom_gpt.simple_chat.system_conversation import OpenAICustomGPTStreamingSimpleChatService
from src.chatflow_langchain.service.openai.custom_gpt.simple_chat.system_conversation_img import OpenAICustomGPTStreamingSimpleChatServiceImg
from src.chatflow_langchain.repositories.custom_gpt_repository import CustomGPTRepository
from src.chatflow_langchain.service.openai.custom_gpt.doc.rag_conversation_img import OpenAICustomGPTStreamingDocChatServiceImg
custom_gpt_repo=CustomGPTRepository()

class OpenAICustomGPTManager():
    def __init__(self):
        self.services = {
            "doc": OpenAICustomGPTStreamingDocChatService(),
            "simple": OpenAICustomGPTStreamingSimpleChatService(),
            "simple_img_gen": OpenAICustomGPTStreamingSimpleChatServiceImg(),
            "doc_img_gen": OpenAICustomGPTStreamingDocChatServiceImg() 
        }
        self.handler_map = {
