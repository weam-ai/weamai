...
from src.prompts.langchain.anthropic.doc_system_prompt import general_system_template,general_ai_template,general_user_template, general_image_template
