...
from src.prompts.langchain.anthropic.custom_gpt.doc_system_prompt import general_ai_template, general_user_question, generic_system_prompt, general_image_template
