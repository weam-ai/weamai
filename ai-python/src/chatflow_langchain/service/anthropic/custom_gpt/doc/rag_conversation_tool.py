...
class AnthropicCustomGPTStreamingDocChatServiceTool(AbstractConversationService):
    def Initilization_custom_gpt(self,custom_gpt_id:str=None,customgptmodel:str=None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.Initilization_custom_gpt"}}
            )
    ...
    def initialize_repository(self, chat_session_id: str = None, collection_name: str = None,regenerated_flag:bool=False,thread_id:str=None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.initialize_repository"}}
            )
    ...
    def initialize_llm(self, company_id:str=None,companymodel: str = None,**kwargs):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.initialize_llm"}}
            )
    ...
    def initialize_memory(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.initialize_memory"}}
            )
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.load_vector_store"}}
            )
    ...
    def prompt_attach(self, additional_prompt_id: str = None, collection_name: str = None):
        ...
        try:
            if additional_prompt_id:
                ...
                if resource_key is not None and resource_value is not None:
                    ...
                    logger.info("Successfully attached additional prompt", extra={
                        "tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.prompt_attach"},
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.prompt_attach"}}
            )
    ...
    def create_conversation(self,input_text:str,**kwargs):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.create_conversation"}}
            )
    ...
    async def tool_calls_run(self, thread_id: str, collection_name: str,regenerated_flag=False, msgCredit=0,is_paid_user=False,**kwargs) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            for tool_call in ai_msg.tool_calls:
                ...
                "tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run"}
            }) 
        ...
        # Handle NotFoundError
            ...
            if error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    ...
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.NotFoundError"}})
            else:
                logger.error(
        ...
        # Handle specific errors like RateLimitError.
            ...
            if error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.RateLimitError"}})
            else:
                logger.error(
            ...
            if not error_code or error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.APIStatusError"}})
                thread_repo.initialization(thread_id, collection_name)
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.AuthenticationError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.PermissionDeniedError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.APIConnectionError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            logger.error(
                ...
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.APITimeoutError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            if not error_code or error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.APIError"}})
                thread_repo.initialization(thread_id, collection_name)
                thread_repo.add_message_openai("common_response")
                content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response")
                error_content = DEV_MESSAGES_CONFIG.get("unknown_message")
            ...
            if not error_code or error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.AnthropicError"}})
                thread_repo.initialization(thread_id, collection_name)
                thread_repo.add_message_openai("common_response")
                content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response")
                error_content = DEV_MESSAGES_CONFIG.get("unknown_message")
            ...
            yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": error_content, "data": content}), status.HTTP_417_EXPECTATION_FAILED
                ...
                try:
                    ...
                    if error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                        logger.warning(
                            f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                            extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.Exception_Try"}})
                    else:
                        logger.error(
                    ...
                    logger.error(
                        ...
                        extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.tool_calls_run.Exception_Except"}})
                    thread_repo.initialization(thread_id, collection_name)
                    thread_repo.add_message_openai("common_response")
                    content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response")
                    yield json.dumps({"status": status.HTTP_400_BAD_REQUEST, "message": DEV_MESSAGES_CONFIG.get("dev_message"), "data": content}), status.HTTP_400_BAD_REQUEST

    @tool(description=ToolServiceDescription.RAG_CONVERSATION)
    ...
    async def website_analysis(self):
        try:
            logger.info(f"Tool 'website_analysis' called", extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.website_analysis"}})
            ...
            if error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.NotFoundError"}})
            else:
                logger.error(
                    f"🚨 Model Not Found Error: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.NotFoundError"}})
        ...
        # Handle specific errors like RateLimitError.
            ...
            if error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.RateLimitError"}})
            else:
                logger.error(
                    f"🚨 Rate Limit Error: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.RateLimitError"}})
            ...
            if not error_code or error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.APIStatusError"}})
                thread_repo.initialization(thread_id, self.collection_name)
                thread_repo.add_message_openai("common_response")
                content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response")
                error_content = DEV_MESSAGES_CONFIG.get("unknown_message")
            ...
            logger.error(
                f"Anthropic Authentication Error: {e}",
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.AuthenticationError"}})
            thread_repo.initialization(thread_id, self.collection_name)
            thread_repo.add_message_openai("authentication_error")
            content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("authentication_error", ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response"))
            yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": e, "data": content}), status.HTTP_417_EXPECTATION_FAILED
            ...
            logger.error(
                f"Anthropic PermissionDenied Error: {e}",
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.PermissionDeniedError"}})
            thread_repo.initialization(thread_id, self.collection_name)
            thread_repo.add_message_openai("permission_error")
            content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("permission_error", ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response"))
            yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": e, "data": content}), status.HTTP_417_EXPECTATION_FAILED
            ...
            logger.error(
                f"Anthropic APIConnection Error: {e}",
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.APIConnectionError"}})
            thread_repo.initialization(thread_id, self.collection_name)
            thread_repo.add_message_openai("api_connection_error")
            content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("api_connection_error", ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response"))
            yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": e, "data": content}), status.HTTP_417_EXPECTATION_FAILED
            ...
            logger.error(
                f"Anthropic APITimeout Error: {e}",
                extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.APITimeoutError"}})
            thread_repo.initialization(thread_id, self.collection_name)
            thread_repo.add_message_openai("api_timeout_error")
            content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("api_timeout_error", ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response"))
            yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": e, "data": content}), status.HTTP_417_EXPECTATION_FAILED
            ...
            if not error_code or error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.APIError"}})
                thread_repo.initialization(thread_id, self.collection_name)
                thread_repo.add_message_openai("common_response")
                content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response")
                error_content = DEV_MESSAGES_CONFIG.get("unknown_message")
            ...
            if not error_code or error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                logger.warning(
                    f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                    extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.AnthropicError"}})
                thread_repo.initialization(thread_id, self.collection_name)
                thread_repo.add_message_openai("common_response")
                content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response")
                error_content = DEV_MESSAGES_CONFIG.get("unknown_message")
            ...
            yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": error_content, "data": content}), status.HTTP_417_EXPECTATION_FAILED
                ...
                try:
                    ...
                    if error_code not in ANTHROPIC_ERROR_MESSAGES_CONFIG:
                        logger.warning(
                            f"👁️ NEW ERROR CODE FOUND: {error_code}, Message: {error_content}",
                            extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.Exception_Try"}})
                    else:
                        logger.error(
                            f"🚨 Failed to stream run conversation: {error_code}, Message: {error_content}",
                            extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.Exception_Try"}})
                    ...
                    logger.error(
                        f"🚨 Failed to stream run conversation: {e}",
                        extra={"tags": {"method": "AnthropicCustomGPTStreamingDocChatServiceTool.stream_run_conversation.Exception_Except"}})
                    thread_repo.initialization(thread_id, self.collection_name)
                    thread_repo.add_message_openai("common_response")
                    content = ANTHROPIC_ERROR_MESSAGES_CONFIG.get("common_response")
                    yield json.dumps({"status": status.HTTP_400_BAD_REQUEST, "message": DEV_MESSAGES_CONFIG.get("dev_message"), "data": content}), status.HTTP_400_BAD_REQUEST
    ...
    async def rag_run_conversation(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            async with  \
                    anthropic_async_callback(llm_apikey_decrypt_service.model_name, cost=cost, thread_id=self.thread_id, collection_name=self.collection_name,encrypted_key=self.encrypted_key,companyRedis_id=self.companyRedis_id,**self.kwargs) as cb, \
                    get_mongodb_callback_handler(thread_id=self.thread_id, chat_history=self.chat_repository_history, memory=self.memory,collection_name=self.collection_name,regenerated_flag=self.regenerated_flag,model_name=llm_apikey_decrypt_service.model_name,msgCredit=self.msgCredit,is_paid_user=self.is_paid_user,encrypted_key=self.encrypted_key,companyRedis_id=self.companyRedis_id) as mongo_handler:
