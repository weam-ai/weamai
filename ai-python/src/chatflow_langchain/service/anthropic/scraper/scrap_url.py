...
from src.chatflow_langchain.service.anthropic.scraper.config import ScraperConfig
...
class AnthropicScrapUrlService():

    def initialize_llm(self, company_id: str = None, companymodel: str = None,llm_api_key_id:str=None):
        try:
            default_llm = DefaultAnthropicModelRepository(company_id=company_id,companymodel=companymodel)
