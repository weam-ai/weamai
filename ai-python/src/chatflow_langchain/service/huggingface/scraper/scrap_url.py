...
from src.celery_worker_hub.web_scraper.tasks.summary import generate_list_summaries_HF
...
from src.chatflow_langchain.service.huggingface.scraper.config import ScraperConfig
import gc
        ...
        try:
            ...
            if available_info is not None:
                ...
                process_chain = chain(
                    ...
                    generate_list_summaries_HF.s(api_key=llm_apikey_decrypt_service.apikey,endpoint_url=llm_apikey_decrypt_service.endpoint_url,notification_data={"token": self.fcm_tokens,"user_data":user_data, "brain_id":brain_id}),
