...
from src.chatflow_langchain.service.huggingface.custom_gpt.doc.rag_conversation import HFCustomGPTStreamingDocChatService
from src.chatflow_langchain.service.huggingface.custom_gpt.simple_chat.system_conversation import HFCustomGPTStreamingSimpleChatService
...
class HFCustomGPTManager():
    def __init__(self):
        self.services = {
            "doc": HFCustomGPTStreamingDocChatService(),
            "simple": HFCustomGPTStreamingSimpleChatService()
        }
        self.handler_map = {
    ...
    async def custom_gpt_doc_handler(self,chat_input,**kwargs): 
        ...
        customgpt_doc_chat.load_vector_store(
            ...
            chat_docs_collection=chat_input.chat_docs_collection
        )
    ...
    async def custom_gpt_chat_handler(self, chat_input, **kwargs):
        ...
        if custom_gpt_repo.get_doc_flag():
