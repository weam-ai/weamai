...
from src.chatflow_langchain.service.weam_router.llama.custom_gpt.config import ToolChatConfig, ImageGenerateConfig
...
@tool(description=LLAMA_TOOL_DESCRIPTION.CUSTOM_GPT_SIMPLE_IMAGE)
