...
from src.prompts.langchain.deepseek.custom_gpt.doc_system_prompt import general_ai_template, general_user_question, generic_system_prompt
...
class UserCustomGPTPrompt:
    ...
    def create_chat_prompt_doc(self,chat_history:str,generic_system_prompt: str = generic_system_prompt, general_user_question: str = general_user_question, general_ai_template: str = general_ai_template, additional_prompt: Optional[str] = None) -> ChatPromptTemplate:
        """
