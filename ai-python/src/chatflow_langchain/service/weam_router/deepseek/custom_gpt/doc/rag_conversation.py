...
class WeamDeepSeekCustomGPTDocChatService(AbstractConversationService):
    ...
    def create_conversation(self,input_text:str,**kwargs):
        ...
        try:
            ...
            qa_prompt = user_custom_prompt.create_chat_prompt_doc(chat_history=self.chat_repository_history.messages,additional_prompt=self.additional_prompt)
