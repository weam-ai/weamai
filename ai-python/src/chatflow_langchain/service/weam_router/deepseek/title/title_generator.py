...
from src.chatflow_langchain.service.weam_router.deepseek.title.chat_prompt_factory import create_chat_prompt_title
from src.chatflow_langchain.service.weam_router.deepseek.title.chat_prompt_factory import prompt_title_without_answer
from src.chatflow_langchain.service.weam_router.deepseek.title.custom_parser import TitleOutputParser
...
from src.chatflow_langchain.service.weam_router.deepseek.title.config import REFORMED_QUERY
import gc
from src.chatflow_langchain.service.weam_router.deepseek.title.utils import extract_error_message, get_default_title
...
from src.custom_lib.langchain.callbacks.weam_router.deep_seek.cost.context_manager import deepseek_sync_callback
import os
...
class WeamDeepSeekTitleGenerationService(AbstractTitleGeneration):
    """
    ...
    def run_chain(self, chat_session_id: str = None, collection_name: str = None, collection_chatmember: str = None):
        ...
        """
        try:
            with deepseek_sync_callback(model_name=self.model_name) as cb :
