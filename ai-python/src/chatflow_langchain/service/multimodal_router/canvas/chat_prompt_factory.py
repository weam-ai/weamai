...
from src.prompts.langchain.multimodal_router.canvas_prompt import general_user_template,general_ai_template,general_system_template_with_code
from src.prompts.langchain.multimodal_router.canvas_prompt import openai_tool_prompt_template,customgpt_doc_prompt_template,customgpt_tool_prompt_template,doc_tool_prompt_template
