...
from src.prompts.langchain.multimodal_router.custom_gpt.doc_system_prompt import general_ai_template, general_user_question, generic_system_prompt, general_image_template
...
class UserCustomGPTPrompt:
    ...
    def create_chat_prompt_doc(self,chat_history:str,generic_system_prompt: str = generic_system_prompt, general_user_question: str = general_user_question, general_ai_template: str = general_ai_template, image_url: Optional[str] = None, additional_prompt: Optional[str] = None) -> ChatPromptTemplate:
        """
        ...
        chat_history.insert(0, SystemMessagePromptTemplate.from_template(user_system_message))
        messages = [
        ...
        if additional_prompt:
            chat_history.append(HumanMessagePromptTemplate.from_template(additional_prompt))
        chat_history.append(HumanMessagePromptTemplate.from_template(general_user_question))
