...
from src.prompts.langchain.multimodal_router.doc_system_prompt import general_system_template,general_ai_template,general_user_template,general_image_template

def create_chat_prompt_doc(chat_history:str,general_system_template=general_system_template, general_user_template=general_user_template, general_ai_template=general_ai_template, image_url: Optional[str] = None, additional_prompt: Optional[str] = None) -> ChatPromptTemplate:
        """
