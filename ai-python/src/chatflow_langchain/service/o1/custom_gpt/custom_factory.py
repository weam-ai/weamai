...
from src.chatflow_langchain.service.o1.custom_gpt.doc.rag_conversation import O1CustomGPTStreamingDocChatService
from src.chatflow_langchain.service.o1.custom_gpt.simple_chat.system_conversation import O1CustomGPTStreamingSimpleChatService
from src.chatflow_langchain.service.o1.custom_gpt.doc.rag_conversation_img import O1CustomGPTStreamingDocChatServiceImg
from src.chatflow_langchain.service.o1.custom_gpt.simple_chat.system_conversation_img import O1CustomGPTStreamingSimpleChatServiceImg
...
class O1CustomGPTManager():
    def __init__(self):
        self.services = {
            "doc": O1CustomGPTStreamingDocChatService(),
            "simple": O1CustomGPTStreamingSimpleChatService(),
            "simple_img_gen": O1CustomGPTStreamingSimpleChatServiceImg(),
            "doc_img_gen": O1CustomGPTStreamingDocChatServiceImg() 
        }
        self.handler_map = {
