...
from src.prompts.langchain.gemini.custom_gpt.doc_system_prompt import general_ai_template, general_user_question, generic_system_prompt, general_image_template
...
class UserCustomGPTPrompt:
    ...
    def create_chat_prompt_doc(self, generic_system_prompt: str = generic_system_prompt, general_user_question: str = general_user_question, 
                               general_ai_template: str = general_ai_template, image_url: Optional[str] = None, additional_prompt: Optional[str] = None) -> ChatPromptTemplate:
        """
        ...
        messages = [
            ...
            HumanMessagePromptTemplate.from_template(generic_system_prompt)]
