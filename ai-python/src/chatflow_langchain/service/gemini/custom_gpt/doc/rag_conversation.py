...
from src.chatflow_langchain.service.gemini.custom_gpt.config import CustomGptDocConfig
...
from src.chatflow_langchain.service.gemini.custom_gpt.doc.utils import extract_google_error_message,extract_google_genai_error_message
...
class GeminiCustomGPTStreamingDocChatService(AbstractConversationService):
    def Initilization_custom_gpt(self,custom_gpt_id:str=None,customgptmodel:str=None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.Initilization_custom_gpt"}}
            )
    ...
    def initialize_repository(self, chat_session_id: str = None, collection_name: str = None,regenerated_flag:bool=False,thread_id:str=None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.initialize_repository"}}
            )
    ...
    def initialize_llm(self, company_id:str=None,companymodel: str = None,**kwargs):
        ...
        try:
            ...
            self.llm_non_stream = ChatGoogleGenerativeAI(model=llm_apikey_decrypt_service.model_name,
                ...
                verbose=False)
            self.llm_sum_memory = ChatGoogleGenerativeAI(model=llm_apikey_decrypt_service.model_name,
                temperature=llm_apikey_decrypt_service.extra_config.get('temprature',0.7),
                google_api_key=llm_apikey_decrypt_service.decrypt(),
                disable_streaming=True,
                verbose=False)
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.initialize_llm"}}
            )
    ...
    def initialize_memory(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.initialize_memory"}}
            )
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.load_vector_store"}}
            )
    ...
    def prompt_attach(self, additional_prompt_id: str = None, collection_name: str = None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.prompt_attach"}}
            )
    ...
    def create_conversation(self,input_text:str,**kwargs):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.create_conversation"}}
            )
    ...
    async def stream_run_conversation(self, thread_id: str, collection_name: str,regenerated_flag:bool=False,msgCredit:float=0,is_paid_user:bool=False,**kwargs) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            async with  \
                    gemini_async_cost_handler(llm_apikey_decrypt_service.model_name, cost=cost, thread_id=thread_id, collection_name=collection_name,**kwargs) as cb, \
        ...
        # Handle ResourceExhaustedError
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.stream_run_conversation.ResourceExhausted"}})
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.stream_run_conversation.GoogleAPICallError"}})
            thread_repo.initialization(thread_id, collection_name)
        ...
        # Handle GoogleAPIError
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.stream_run_conversation.GoogleAPIError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.stream_run_conversation.GoogleGenerativeAIError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            try:
                ...
                try:
                    ...
                    logger.warning(
                        ...
                        extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.Exception.extract_google_error_message"}})
                ...
                if not error_content:
                    try:
                        ...
                        logger.warning(
                            ...
                            extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.Exception.extract_google_genai_error_message"}})
                ...
                logger.error(
                    ...
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.stream_run_conversation.Exception_Try"}})
                thread_repo.initialization(thread_id, collection_name)
                ...
                logger.error(
                    ...
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.stream_run_conversation.Exception_Except"}})
                thread_repo.initialization(thread_id, collection_name)
                thread_repo.add_message_gemini("common_response")
        ...
        try:
            ...
            if cleaned_up:
                logger.info(
                    ...
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatService.cleanup"}}
                )
