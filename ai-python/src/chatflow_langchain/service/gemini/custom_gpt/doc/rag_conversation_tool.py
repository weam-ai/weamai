...
from src.chatflow_langchain.service.gemini.custom_gpt.config import ToolChatConfig
...
from src.chatflow_langchain.service.gemini.custom_gpt.doc.chat_prompt_factory import UserCustomGPTPrompt
...
from src.chatflow_langchain.service.gemini.custom_gpt.config import CustomGptDocConfig,GetLLMkey
...
class GeminiCustomGPTStreamingDocChatServiceTool(AbstractConversationService):
    def Initilization_custom_gpt(self,custom_gpt_id:str=None,customgptmodel:str=None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.Initilization_custom_gpt"}}
            )
    ...
    def initialize_repository(self, chat_session_id: str = None, collection_name: str = None,regenerated_flag:bool=False,thread_id:str=None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.initialize_repository"}}
            )
    ...
    def initialize_llm(self, company_id:str=None,companymodel: str = None,**kwargs):
        ...
        try:
            ...
            self.llm_non_stream = ChatGoogleGenerativeAI(model=GEMINIMODEL.DEFAULT_TOOL_MODEL,
                ...
                verbose=False)
            self.llm_sum_memory = ChatGoogleGenerativeAI(model=self.model_name,
                temperature=llm_apikey_decrypt_service.extra_config.get('temprature',0.7),
                api_key=llm_apikey_decrypt_service.decrypt(),
                disable_streaming=True,
                verbose=False)
            ...
            self.query_arguments = {'wrapper_rag_conversation':{},'wrapper_website_analysis':{}}
            
        except Exception as e:
            logger.error(
                f"Failed to initialize LLM: {e}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.initialize_llm"}}
            )
    ...
    def initialize_memory(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.initialize_memory"}}
            )
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.load_vector_store"}}
            )
    ...
    def prompt_attach(self, additional_prompt_id: str = None, collection_name: str = None):
        ...
        try:
            if additional_prompt_id:
                ...
                if resource_key is not None and resource_value is not None:
                    ...
                    logger.info("Successfully attached additional prompt", extra={
                        "tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.prompt_attach"},
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.prompt_attach"}}
            )
    ...
    def create_conversation(self,input_text:str,**kwargs):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.create_conversation"}}
            )
    ...
    async def tool_calls_run(self, thread_id: str, collection_name: str,regenerated_flag=False, msgCredit=0,is_paid_user=False,**kwargs) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            for tool_call in ai_msg.tool_calls:
                ...
                "tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.tool_calls_run"}
            })
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.tool_calls_run.ResourceExhausted"}})
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.tool_calls_run.GoogleAPICallError"}})
            thread_repo.initialization(thread_id, collection_name)
        ...
        # Handle GoogleAPIError
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.tool_calls_run.GoogleAPIError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.tool_calls_run.GoogleGenerativeAIError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            try:
                ...
                try:
                    ...
                    logger.warning(
                        ...
                        extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.Exception.extract_google_error_message"}})
                ...
                if not error_content:
                    try:
                        ...
                        logger.warning(
                            ...
                            extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.Exception.extract_google_genai_error_message"}})
                ...
                logger.error(
                    ...
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.tool_calls_run.Exception_Try"}})
                thread_repo.initialization(thread_id, collection_name)
                ...
                logger.error(
                    ...
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.tool_calls_run.Exception_Except"}})
                thread_repo.initialization(thread_id, collection_name)
                thread_repo.add_message_gemini("common_response")
    ...
    async def website_analysis(self):
        try:
            logger.info(f"Tool 'website_analysis' called", extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.website_analysis"}})
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.website_analysis.ResourceExhausted"}})
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.website_analysis.GoogleAPICallError"}})
            thread_repo.initialization(thread_id, thread_model)
            thread_repo.add_message_gemini("google_api_call_error")
            # llm_apikey_decrypt_service.update_deprecated_status(True)
            content = GENAI_ERROR_MESSAGES_CONFIG.get("google_api_call_error", GENAI_ERROR_MESSAGES_CONFIG.get("common_response"))
        ...
        # Handle GoogleAPIError
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.website_analysis.GoogleAPIError"}})
            thread_repo.initialization(thread_id, thread_model)
            thread_repo.add_message_gemini("google_api_error")
            # llm_apikey_decrypt_service.update_deprecated_status(True)
            content = GENAI_ERROR_MESSAGES_CONFIG.get("google_api_error", GENAI_ERROR_MESSAGES_CONFIG.get("common_response"))
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.website_analysis.GoogleGenerativeAIError"}})
            thread_repo.initialization(thread_id, thread_model)
            thread_repo.add_message_gemini("google_genai_error")
            # llm_apikey_decrypt_service.update_deprecated_status(True)
            content = GENAI_ERROR_MESSAGES_CONFIG.get("google_genai_error", GENAI_ERROR_MESSAGES_CONFIG.get("common_response"))
            ...
            try:
                ...
                logger.error(
                    f"🚨 Failed to stream run conversation: {error_content}",
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.website_analysis.Exception_Try"}})
                thread_repo.initialization(thread_id, thread_model)
                thread_repo.add_message_gemini("common_response")
                content = GENAI_ERROR_MESSAGES_CONFIG.get("common_response", GENAI_ERROR_MESSAGES_CONFIG.get("common_response"))
                yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": error_content, "data": content}), status.HTTP_417_EXPECTATION_FAILED  
                ...
                logger.error(
                    f"🚨 Failed to stream run conversation: {inner_e}",
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.website_analysis.Exception_Except"}})
                thread_repo.initialization(thread_id, thread_model)
                thread_repo.add_message_gemini("common_response")
                content = GENAI_ERROR_MESSAGES_CONFIG.get("common_response")
                yield json.dumps({"status": status.HTTP_400_BAD_REQUEST, "message": DEV_MESSAGES_CONFIG.get("genai_message"), "data": content}), status.HTTP_400_BAD_REQUEST
    ...
    async def rag_run_conversation(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            async with  \
                    gemini_async_cost_handler(model_name=self.model_name, thread_id=self.thread_id, collection_name=collection_name,encrypted_key=self.encrypted_key,companyRedis_id=self.companyRedis_id,**self.kwargs) as cb, \
                    get_mongodb_callback_handler(thread_id=thread_id, chat_history=self.chat_repository_history, memory=self.memory,collection_name=collection_name,regenerated_flag=self.regenerated_flag,msgCredit=self.msgCredit,is_paid_user=self.is_paid_user,model_name=self.model_name,encrypted_key=self.encrypted_key,companyRedis_id=self.companyRedis_id) as mongo_handler:

                 async for token in self.conversational_retrieval_chain.astream_events(self.inputs,{"callbacks":[cb,mongo_handler]},version="v1",stream_usage=True):
                    if token['event']=="on_chat_model_stream":
                        max_chunk_size = 5  # Set your desired chunk size
                        chunk=token['data']['chunk'].content
                        for i in range(0, len(chunk), max_chunk_size):
        ...
        # Handle ResourceExhaustedError
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.stream_run_conversation.ResourceExhausted"}})
            thread_repo.initialization(thread_id, collection_name)
            thread_repo.add_message_gemini("resource_exhausted_error")
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.stream_run_conversation.GoogleAPICallError"}})
            thread_repo.initialization(thread_id, collection_name)
            thread_repo.add_message_gemini("google_api_call_error")
        ...
        # Handle GoogleAPIError
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.stream_run_conversation.GoogleAPIError"}})
            thread_repo.initialization(thread_id, collection_name)
            thread_repo.add_message_gemini("google_api_error")
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.stream_run_conversation.GoogleGenerativeAIError"}})
            thread_repo.initialization(thread_id, collection_name)
            thread_repo.add_message_gemini("google_genai_error")
            ...
            try:
                ...
                logger.error(
                    f"🚨 Failed to stream run conversation: {error_content}",
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.stream_run_conversation.Exception_Try"}})
                thread_repo.initialization(thread_id, collection_name)
                thread_repo.add_message_gemini("common_response")
                content = GENAI_ERROR_MESSAGES_CONFIG.get("common_response", GENAI_ERROR_MESSAGES_CONFIG.get("common_response"))
                yield json.dumps({"status": status.HTTP_417_EXPECTATION_FAILED, "message": error_content, "data": content}), status.HTTP_417_EXPECTATION_FAILED  
                ...
                logger.error(
                    f"🚨 Failed to stream run conversation: {inner_e}",
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.stream_run_conversation.Exception_Except"}})
                thread_repo.initialization(thread_id, collection_name)
                thread_repo.add_message_gemini("common_response")
                content = GENAI_ERROR_MESSAGES_CONFIG.get("common_response")
                yield json.dumps({"status": status.HTTP_400_BAD_REQUEST, "message": DEV_MESSAGES_CONFIG.get("genai_message"), "data": content}), status.HTTP_400_BAD_REQUEST
        ...
        try:
            ...
            if cleaned_up:
                logger.info(
                    ...
                    extra={"tags": {"method": "GeminiCustomGPTStreamingDocChatServiceTool.cleanup"}}
                )
