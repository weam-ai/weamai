...
from src.prompts.langchain.gemini.canvas_prompt import general_system_template,\
...
from src.prompts.langchain.gemini.canvas_prompt import openai_tool_prompt_template,customgpt_doc_prompt_template,customgpt_tool_prompt_template,doc_tool_prompt_template
