...
from src.chatflow_langchain.service.gemini.image.utils import extract_google_error_message,extract_google_genai_error_message
    ...
    async def run_image_generation(self,thread_id: str, collection_name: str,**kwargs):
        ...
        # Handle ResourceExhaustedError
            ...
            logger.error(
                ...
                extra={"tags": {"method": "OpenAIImageGenerationService.run_image_generation.ResourceExhausted"}})
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "OpenAIImageGenerationService.run_image_generation.GoogleAPICallError"}})
            thread_repo.initialization(thread_id, collection_name)
        ...
        # Handle GoogleAPIError
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "OpenAIImageGenerationService.run_image_generation.GoogleAPIError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            logger.error(
                f"🚨 Google API Error: {error_content}",
                extra={"tags": {"method": "OpenAIImageGenerationService.run_image_generation.GoogleGenerativeAIError"}})
            thread_repo.initialization(thread_id, collection_name)
            ...
            try:
                ...
                try:
                    ...
                    logger.warning(
                        ...
                        extra={"tags": {"method": "OpenAIImageGenerationService.Exception.extract_google_error_message"}})
                ...
                if not error_content:
                    try:
                        ...
                        logger.warning(
                            ...
                            extra={"tags": {"method": "OpenAIImageGenerationService.Exception.extract_google_genai_error_message"}})
