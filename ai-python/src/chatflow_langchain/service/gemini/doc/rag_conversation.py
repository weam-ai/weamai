...
from src.chatflow_langchain.service.gemini.doc.chat_prompt_factory import create_chat_prompt_doc
...
from src.chatflow_langchain.service.gemini.doc.config import DocConfig
...
from src.chatflow_langchain.service.config.model_config_gemini import GEMINIMODEL
...
class GeminiStreamingDocumentedChatService(AbstractConversationService):
    def initialize_llm(self, api_key_id: str = None, companymodel: str = None,thread_id:str=None,thread_model:str=None):
        ...
        try:
            ...
            self.encrpyted_key=llm_apikey_decrypt_service.apikey
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiStreamingDocumentedChatService.initialize_llm"}}
            )
    ...
    def initialize_repository(self, chat_session_id: str = None, collection_name: str = None,regenerated_flag:bool=False,thread_id:str=None):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiStreamingDocumentedChatService.initialize_repository"}}
            )
    ...
    def initialize_memory(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiStreamingDocumentedChatService.initialize_memory"}}
            )
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiStreamingDocumentedChatService.load_vector_store"}}
            )
    ...
    def prompt_attach(self, additional_prompt_id: str = None, collection_name: str = None):
        ...
        try:
            if additional_prompt_id:
                ...
                if resource_key is not None and resource_value is not None:
                    ...
                    logger.info("Successfully attached additional prompt", extra={
                        "tags": {"method": "GeminiStreamingDocumentedChatService.prompt_attach"},
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiStreamingDocumentedChatService.prompt_attach"}}
            )
    ...
    def create_conversation(self,tag: str,input_text:str,**kwargs):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiStreamingDocumentedChatService.create_conversation"}}
            )
    ...
    async def stream_run_conversation(self, thread_id: str, collection_name: str,regenerated_flag:bool=False,msgCredit:float=0,is_paid_user:bool=False,**kwargs) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            cost = CostCalculator()
            async with gemini_async_cost_handler(model_name=llm_apikey_decrypt_service.model_name,thread_id=thread_id,collection_name=collection_name,encrypted_key=self.encrpyted_key,companyRedis_id=self.companyRedis_id) as cb,\
            get_mongodb_callback_handler(thread_id=thread_id, chat_history=self.chat_repository_history, memory=self.memory,collection_name=collection_name,regenerated_flag=regenerated_flag,model_name=llm_apikey_decrypt_service.model_name,msgCredit=msgCredit,is_paid_user=is_paid_user,encrypted_key=self.encrpyted_key,companyRedis_id=self.companyRedis_id) as mongo_handler:
    ...
    def cleanup(self):
        ...
        try:
            ...
            logger.error(
                ...
                extra={"tags": {"method": "GeminiStreamingDocumentedChatService.cleanup"}}
            )