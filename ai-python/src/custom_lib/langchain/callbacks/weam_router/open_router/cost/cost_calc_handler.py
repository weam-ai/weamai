...
MODEL_COST_PER_1K_INPUT_TOKENS = {
    "meta-llama/llama-4-maverick":0.00022,
    ...
    "qwen/qwen3-30b-a3b:free":0,
    "x-ai/grok-3-mini-beta":0.0003
}   

MODEL_COST_PER_1K_OUTPUT_TOKENS = {
    "meta-llama/llama-4-maverick":0.0008,
    "meta-llama/llama-4-maverick:free": 0,
    ...
    "deepseek/deepseek-r1:free":0,
    "qwen/qwen3-30b-a3b:free":0,
    "x-ai/grok-3-mini-beta":0.0005
}

# Added grok model token grok-qwen-model

def _get_openrouter_token_cost(
...
class OpenRouterTokenUsageCallbackAsync(AsyncCallbackHandler):
    ...
    async def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        total_cost = _get_openrouter_token_cost(
    ...
    async def __copy__(self) -> "WeamOpenRouterUsageCallbackAsync":
        """Return a copy of the callback handler."""
        return self

    async def __deepcopy__(self, memo: Any) -> "WeamOpenRouterUsageCallbackAsync":
...
class OpenRouterTokenUsageCallbackSync(BaseCallbackHandler):
    ...
    def __copy__(self) -> "WeamOpenRouterTokenUsageCallbackSync":
        """Return a copy of the callback handler."""
        return self

    def __deepcopy__(self, memo: Any) -> "WeamOpenRouterTokenUsageCallbackSync":
        """Return a deep copy of the callback handler."""
        return self