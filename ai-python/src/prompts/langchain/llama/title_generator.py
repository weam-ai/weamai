...
Entities with the highest weight must take precedence in the title.
Entities with medium weight should follow if space allows.
Entities with the lowest weight should only be included if necessary to complete the title.
